...
<? require("tpl/haut.php"); ?>
		...
		<div>
			...
			<p>Chacun a eu, ou a des professeurs passionnés, passionnants, doués pour transmettre leur savoir et faire aimer leur matière aux élèves.</p>
			...
			<p>Il faut bien comprendre cependant que ce site est un moyen d'expression pour les élèves, et que les notes sont des appréciations personnelles, elles ne viennent donc d'aucune manière remettre en question les évaluations faites par des entités agréées professionnellement.</p>
